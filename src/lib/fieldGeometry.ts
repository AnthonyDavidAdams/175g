...
export const PRESETS: FieldPreset[] = [
  {
    ...
    widthM: 37,
    endzoneM: 18,
    note: "USAU / WFDF outdoor. 64m playing field proper plus two 18m end zones.",
  },
  {
    key: "beach_5v5",
    label: "Beach 5v5",
    ...
    widthM: 25,
    endzoneM: 15,
    note: "WFDF beach standard. Lined with rope and stakes, not paint.",
  },
  {
    key: "beach_4v4",
    label: "Beach 4v4",
    ...
    widthM: 20,
    endzoneM: 12,
    note: "Smaller beach field for 4v4 and mixed-format beach events.",
  },
  {
    key: "youth",
    ...
    widthM: 27,
    endzoneM: 15,
    note: "Common for youth and 5v5 grass formats.",
  },
  {
    key: "indoor",
    label: "Indoor",
    ...
    widthM: 25,
    endzoneM: 8,
    note: "Varies enormously by venue — measure the actual hall before committing.",
  },
  {
    key: "custom",
    label: "Custom",
    ...
    widthM: 37,
    endzoneM: 18,
    note: "Set your own dimensions. They save with the field.",
  },
];
